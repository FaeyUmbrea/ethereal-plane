<script>
    ...
    function startPoll(){
        ...
        Server.getServer().createPoll(options.map((_val,index) => index.toString()),30000);
    }
</script>
...
<div class="editor">
    ...
    <div class="buttons">
        <button class="addrem" on:click={addOption}><i class="fas fa-plus"></i></button>
        <button class="addrem" on:click={removeOption}><i class="fas fa-minus"></i></button>
