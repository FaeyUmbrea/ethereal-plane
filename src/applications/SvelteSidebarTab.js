...
import { Position }           from '../../node_modules/@typhonjs-fvtt/runtime/_dist/svelte/application/position/Position.js';
...
import {
    ...
    isHMRProxy,
    isObject,
    outroAndDestroy }          from '../../node_modules/@typhonjs-fvtt/runtime/_dist/svelte/util';

import {
    ApplicationState,
    GetSvelteData,
    loadSvelteConfig,
    SvelteReactive }           from '../../node_modules/@typhonjs-fvtt/runtime/_dist/svelte/application/internal/index.js';

/**
 * Provides a Svelte aware extension to Application to control the app lifecycle appropriately. You can declaratively
 * load one or more components from `defaultOptions`.
 */
export class SvelteSidebarTab extends SidebarTab
{
    /**
